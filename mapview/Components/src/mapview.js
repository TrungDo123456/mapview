...
import DeckSwiperExample from '../src/DeckSwiper'
...
const cards = [
  {
    ...
    time:'9:30 - 22:00',
    image: require('../src/images/gongcha1.jpg'),
  },
  {
    ...
    time:'9:30 - 21:30',
    image: require('../src/images/gongcha2.jpg'),
  },
  {
    ...
    time:'9:30 - 21:30',
    image: require('../src/images/gongcha3.jpg'),
  },
  {
    ...
    time:'9:00-22:30',
    image: require('../src/images/gongcha4.jpg'),
  },
  {
    ...
    time:'9:00 - 22:00',
    image: require('../src/images/gongcha5.jpg'),
  },
];
            ...
            <View style={styles.view_textinput}>
                ...
                <View style={{flex:1}}>
                    <TouchableOpacity style={styles.go} onPress={()=>this.Go(this.state.keySearch)}>
                        <Image  source={require('./icon/right-arrow.png')}/>
                    </TouchableOpacity>
                </View>
                <View style={{flex:2}}/>  
            </View>
